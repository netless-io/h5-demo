(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.NetlessIframeSDK = {}));
	...
	(function (BridgeEvent) {
	    BridgeEvent["Init"] = "Init";
	    BridgeEvent["AttributesUpdate"] = "AttributesUpdate";
	    BridgeEvent["SetAttributes"] = "SetAttributes";
	    BridgeEvent["DispatchMagixEvent"] = "DispatchMagixEvent";
	    BridgeEvent["ReciveMagixEvent"] = "ReciveMagixEvent";
	    BridgeEvent["RegisterMagixEvent"] = "RegisterMagixEvent";
	    BridgeEvent["RemoveMagixEvent"] = "RemoveMagixEvent";
	    BridgeEvent["RemoveAllMagixEvent"] = "RemoveAllMagixEvent";
	    BridgeEvent["RoomStateChanged"] = "RoomStateChanged";
	    BridgeEvent["NextPage"] = "NextPage";
	    BridgeEvent["PrevPage"] = "PrevPage";
	})(BridgeEvent || (BridgeEvent = {}));
	(function (Events) {
	    Events["AttributesUpdate"] = "AttributesUpdate";
	    Events["RoomStateChanged"] = "RoomStateChanged";
	})(exports.Events || (exports.Events = {}));
	var NetlessIframeSDK = /** @class */ (function () {
	    function NetlessIframeSDK(targetOrigin, attributes, roomState) {
	        var _this = this;
	        this.targetOrigin = "*";
	        this.emitter = new eventemitter2.EventEmitter2();
	        this.magixEmitter = new eventemitter2.EventEmitter2();
	        this.magixListenerMap = new Map();
	    ...
	    NetlessIframeSDK.prototype.messageListener = function (event) {
	        ...
	        switch (data.kind) {
	            case BridgeEvent.AttributesUpdate: {
	                ...
	                this.emitter.emit(exports.Events.AttributesUpdate, data.payload);
	                break;
	            }
	            ...
	            case BridgeEvent.RoomStateChanged: {
	                ...
	                this.emitter.emit(exports.Events.RoomStateChanged, data.payload);
	                break;
	            }
	            default: {
	    ...
	    Object.defineProperty(NetlessIframeSDK.prototype, "attributes", {
	        get: function () {
	    ...
	    NetlessIframeSDK.prototype.setAttributes = function (payload) {
	        var newAttibutes = __assign({}, this.attributes);
	    ...
	    Object.defineProperty(NetlessIframeSDK.prototype, "roomState", {
	        get: function () {
	    ...
	    Object.defineProperty(NetlessIframeSDK.prototype, "currentIndex", {
	        get: function () {
	    ...
	    Object.defineProperty(NetlessIframeSDK.prototype, "currentPage", {
	        get: function () {
	    ...
	    Object.defineProperty(NetlessIframeSDK.prototype, "totalPages", {
	        get: function () {
	    ...
	    NetlessIframeSDK.prototype.postMessage = function (kind, payload) {
	        parent.postMessage({ kind: kind, payload: payload }, this.targetOrigin);
	    };
	    NetlessIframeSDK.prototype.on = function (event, listener) {
	        this.emitter.addListener(event, listener);
	    };
	    NetlessIframeSDK.prototype.off = function (event, listener) {
	        this.emitter.off(event, listener);
	    };
	    NetlessIframeSDK.prototype.addMagixEventListener = function (event, listener) {
	        this.magixEmitter.on(event, listener);
	        var count = this.magixListenerMap.get(event);
	        this.magixListenerMap.set(event, (count || 0) + 1);
	        if (count === undefined) {
	            this.postMessage(BridgeEvent.RegisterMagixEvent, event);
	        }
	    };
	    NetlessIframeSDK.prototype.dispatchMagixEvent = function (event, payload) {
	        this.postMessage(BridgeEvent.DispatchMagixEvent, { event: event, payload: payload });
	    };
	    NetlessIframeSDK.prototype.removeMagixEventListener = function (event, listener) {
	        var count = this.magixListenerMap.get(event);
	        if (count === undefined) {
	...
	exports.NetlessIframeSDK = NetlessIframeSDK;
	exports.createNetlessIframeSDK = createNetlessIframeSDK;
